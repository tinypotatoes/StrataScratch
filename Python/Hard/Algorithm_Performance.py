...
https://platform.stratascratch.com/coding/10350-algorithm-performance?code_type=2
...
fb_search_events.loc[fb_search_events["clicked"] == 0, "rank"] = 1
fb_search_events.loc[(fb_search_events["clicked"] == 1) & (fb_search_events["search_results_position"] > 3), "rank"] = 2
fb_search_events.loc[(fb_search_events["clicked"] == 1) & (fb_search_events["search_results_position"] <= 3), "rank"] = 3
df = fb_search_events.groupby("search_id")["rank"].max().reset_index()
